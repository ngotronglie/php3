                ...
                <div class="row">
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100"
                                            src="{{ asset('theme/client/assets/images/products/large-size/1.jpg') }}"
                                            alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100"
                                            src="{{ asset('theme/client/assets/images/products/large-size/2.jpg') }}"
                                            alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100"
                                            src="{{ asset('theme/client/assets/images/products/large-size/3.jpg') }}"
                                            alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100"
                                            src="{{ asset('theme/client/assets/images/products/large-size/4.jpg') }}"
                                            alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100"
                                            src="{{ asset('theme/client/assets/images/products/large-size/5.jpg') }}"
                                            alt="Product">
                                    </a>
                                    <a class="swiper-slide" href="#">
                                        <img class="w-100"
                                            src="{{ asset('theme/client/assets/images/products/large-size/6.jpg') }}"
                                            alt="Product">
                                    </a>
                                </div>
                    ...
                    <div class="col-md-6 col-12 overflow-hidden position-relative">
                        ...
                        <div class="product-summery">
                            ...
                            <!-- Description Start -->
                            <p class="desc-content mb-5">I must explain to you how all this mistaken idea of
                            ...
                            <div class="cart-wishlist-btn pb-4 mb-n3">
                                <div class="add-to_cart mb-3">
                                    <a class="btn btn-outline-dark btn-hover-primary" href="cart.html">Add to
                                        cart</a>
                                </div>

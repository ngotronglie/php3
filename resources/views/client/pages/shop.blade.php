                                ...
                                <div class="thumb">
                                    <a href="single-product.html" class="image">
                                        <img class="first-image"
                                            src="{{ asset('theme/client/assets/images/products/medium-size/2.jpg') }}"
                                            alt="Product" />
                                        <img class="second-image"
                                            src="{{ asset('theme/client/assets/images/products/medium-size/3.jpg') }}"
                                            alt="Product" />
                                    </a>
                                    <div class="actions">
                                ...
                                <div class="thumb">
                                    <a href="single-product.html" class="image">
                                        <img class="first-image"
                                            ...
                                            alt="Product" />
                                        <img class="second-image"
                                            src="{{ asset('theme/client/assets/images/products/medium-size/6.jpg') }}"
                                            alt="Product" />
                                    </a>
                                    <div class="actions">
                                        <a href="wishlist.html" title="Wishlist" class="action wishlist"><i
                                        ...
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img class="first-image"
                                                    ...
                                                    alt="Product" />
                                                <img class="second-image"
                                                    src="{{ asset('theme/client/assets/images/products/small-product/5.jpg') }}"
                                                    alt="Product" />
                                            </a>
                                        </div>
                                        <div class="content">

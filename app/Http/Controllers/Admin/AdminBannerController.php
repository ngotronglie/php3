...
class AdminBannerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view("admin.banner.list", compact("title", "listBanner"));
    }
    ...
    public function store(Request $request)
    {
        if ($request->ismethod('POST')) {
            ...
            return redirect()->route('admin.banners.list')->with('success', 'Them banner thanh cong !');
        }
    }
    ...
    public function update(Request $request, string $id)
    {
        if ($request->isMethod('put')) {
            ...
            return redirect()->route('admin.banners.list')->with('success', 'Sua banner thanh cong !');
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('admin.banners.list')->with('success', 'Xoa banner thanh cong !');
    }
}